...
class PerbandinganAlternatifController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Admin.perbandingan-alternatif.index', compact('kriteriaList'));
    }

    public function index_hasil()
    {
        $kriteriaList = Kriteria::all();

        return view('Admin.hasil-perbandingan-alternatif.index', compact('kriteriaList'));
    }
